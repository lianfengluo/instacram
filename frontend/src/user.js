...
export function register_form_show() {
    ...
    input_div.appendChild(username_input);
    let br = createElement("br", null);
    input_div.appendChild(br);
    input_div.appendChild(password_input);
...
const signup_submit = () => {
    const form = document.getElementById("reigster_form");
    const username = document.getElementById("username-input").value;
    const password = document.getElementById("password-input").value;
...
function show_register_button() {
    const submit_register_button = document.getElementById("signup-submit-button");
    submit_register_button.addEventListener("click", signup_submit);
}